...
struct MapView: View {
    ...
    @State private var region: MKCoordinateRegion = {
        ...
        var mapZoomLever = MKCoordinateSpan(latitudeDelta: 70.0, longitudeDelta: 70.0)
        var mapRegion = MKCoordinateRegion(center: mapCoordinates, span: mapZoomLever)
        return mapRegion
    }()
